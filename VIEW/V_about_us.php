        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="main-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="?controller=trangchu" class="nav-link">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="about-us">
        <div class="container ">
            ...
            <div class="row ml-1">
                ...
                <p>Cửa hàng đồ chơi TiTan <br><br>

                Chuyên về những phụ kiện, vật phẩm, đồ trang trí<br><br>

                - Liên minh huyền thoại, Overwatch, ...<br><br>

                - Phụ kiện anime : Onepiece, Naruto, dragonball, Attack on Titan...<br><br>

                - Vật phẩm trong siêu anh hùng... Chất lượng đảm bảo - uy tín - Độc nhất<br><br>

                Địa chỉ :<br><br>

                19 Trần Đại Nghĩa - Hai Bà Trưng - Hà Nội<br><br>
                ...
                Địa chỉ page : http://facebook.com/TiTan360<br><br>

                Địa chỉ website : http://titangift.vn/</p>
            </div>
        </div>
    </section>
