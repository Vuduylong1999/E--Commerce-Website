        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <img src="../img/sinon.jpg" alt="" style="width:100%">
                </div>
                <div class="col-lg-5 col-md-5 col-sm-12 px-5 pt-5">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="submit" class="btn1 mt-3 mb-5" name="btnlogin" value="Login">
                            </div>
                        </div>
                        <a href="#">Forgot Password?</a>
                        <p>Don't have account? <a href="?controller=signup">Register here</a></p>
                    </form>
                </div>
            </div>
        </div>
